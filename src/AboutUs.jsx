...
function AboutUs() {
  return (
    <div className="about-us-container">
      ...
      <p className="about-us-description">Welcome to Ecopure Nursery, where green meets serenity!</p>
      ...
      <p className="about-us-content">
        Join us in our mission to create a greener, healthier world. Visit Ecopure Nursery today and experience the 
